                            ...
                            <center>
                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <a class="btn btn-dark col-sm-12"  href="{{route('generalManagerSponsoringCompanies.edit',['generalManagerSponsoringCompany'=>1])}}">تعديل</a>
                                            <form method="post" action="{{route('generalManagerSponsoringCompanies.destroy',['generalManagerSponsoringCompany'=>1])}}">
                                                @csrf
                                                @method('DELETE')
