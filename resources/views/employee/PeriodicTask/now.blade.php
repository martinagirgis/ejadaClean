...
$timestamp = $time->format("Y/m/d H:i:s");
                            ...
                            <!--<th class="btn btn-danger w-50 m-auto">انتهت منذ {{intval($minute)}} دقيقة</th>-->
                                ...
                                @else
                                    <th>                                
                                        <a class="btn btn-dark col-sm-12" href="{{route('periodicTask.Delay',['id' => $task->id])}}">طلب مد الوقت</a><br>
                                    </th>
                                @endif
                            @else
                            <th>
                            ...
                            <!--<th class="btn btn-success w-50 m-auto">متبقي {{abs(intval($minute))}} دقيقة</th>-->
                                ...
                                @else
                                <th>                                
                                    <a class="btn btn-dark col-sm-12" href="{{route('periodicTask.Send',['id' => $task->id])}}">تسليم</a><br>
                                </th>
                                @endif
                            @endif
...
<script>
    function getTask()
    {
        ...
        location.href = '/employee/periodicTaskNow/searsh/' + $date;
    }
</script>
