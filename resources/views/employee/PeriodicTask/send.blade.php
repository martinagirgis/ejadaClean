        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="wrapper">
                        <form method="POST" action="{{route('periodicTask.SendStore')}}" enctype="multipart/form-data" id="myform">
                            @csrf
...
@section('script')
            ...
            <script>
        var SITEURL = "{{route('periodicTask.SendStore')}}";
        $(function() {
            $(document).ready(function()
            {
                ...
                $('#myform').ajaxForm({
                    ...
                    complete: function(xhr) {
                        ...
                        window.location.href = "{{route('periodicTask.Waiting')}}";
                    }
                });
            });
        });
