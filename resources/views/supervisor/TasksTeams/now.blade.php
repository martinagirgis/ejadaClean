                    ...
                    <tbody>
                        ...
                        {{-- {{dd($task['employee']['name'])}}                              --}}
                            <tr>
                                ...
                                <th>{{$task['period']}}</th>
                                <th>                                
                                    <a class="btn btn-dark col-sm-12" href="{{route('supervisor.task.SendTeam',['id' => $task->id])}}">تسليم</a><br>
                                </th>
                            </tr>
                        @endforeach
...
<script>
    function getTask()
    {
        ...
        location.href = "/supervisor/tasks/company/now/searsh/" + $date;
