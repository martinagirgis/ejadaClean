        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <h5 class="mb-5 mt-3"> تعديل وقت المهمة </h5>
                    <div class="wrapper">
                        <form method="POST" action="{{route('supervisor.PeriodicTasks.renewDelay')}}" enctype="multipart/form-data" id="myform">
                            @csrf
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">عنوان المهمه</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" id="example-text-input" disabled name="title" value="{{$task->title}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="3" id="example-text-input" name="description" disabled required>{{$task->description}} </textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="emptype" name="type" disabled>
                                        @if($task->type == '0')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" disabled name="support_type" id="support_type">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" disabled id="emp" name="support_id" required>
                                        @if($task->support_type == '0')
    ...
    <script>
        $(document).ready(function(){
           $('#support_type').on('change', function() {
               ...
               console.log(emptype);
               $.ajax({
               url:'http://127.0.0.1:8000/getTypeMempers',
                   method:"get",
                   data:{type:id},
                   dataType:"json",
                   headers: {
