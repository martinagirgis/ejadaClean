                                        ...
                                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                    <a class="btn btn-dark col-sm-12"  href="{{route('supervisor.PeriodicTasks.show',['id'=>$task[$i]['id']])}}">عرض</a><br>                                                    
                                                </div>
                                            </div>
                                        </div>
                                    </center>
                                        ...
                                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                    ...
                                                    <a class="btn btn-dark col-sm-12" href="{{route('supervisor.PeriodicTasks.accept',['id'=>$task[$i]['id']])}}">قبول </a><br>
                                                    <a class="btn btn-dark col-sm-12" href="{{route('supervisor.PeriodicTasks.refused',['id'=>$task[$i]['id']])}}">رفض</a><br>
                                    ...
                                    <center>
                                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                    <a class="btn btn-dark col-sm-12"  href="{{route('supervisor.PeriodicTasks.show',['id'=>$task[$i]['id']])}}">عرض</a><br>
                                                    <a class="btn btn-dark col-sm-12"  href="{{route('supervisor.PeriodicTasks.DelayAccept',['id'=>$task[$i]['id']])}}">قبول</a><br>
                                                    <a class="btn btn-dark col-sm-12"  href="{{route('supervisor.PeriodicTasks.DelayRefused',['id'=>$task[$i]['id']])}}">رفض</a><br>
                                                </div>
                                            </div>
                                        </div>
                                    </center>
...
<script>
    function getTask()
    {
        ...
        location.href = "/supervisor/periodic/{{$type}}/searsh/" + $date;
    }
</script>
@endsection
@section("script")
