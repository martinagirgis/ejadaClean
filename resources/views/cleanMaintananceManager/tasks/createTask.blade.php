        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <h5 class="mb-5 mt-3">اضافة مهمة جديد</h5>
                    <div class="wrapper">
                        <form method="POST" action="{{route('managerClean.StoreTask')}}" enctype="multipart/form-data" id="myform">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="3" id="example-text-input" name="description" required> </textarea>
                                </div>
                            </div>
                            ...
                            <div class='form-group row'>
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="date" value="{{ date('Y-m-d') }}" id="example-text-input" name="date" required>
                                </div>
                            </div>
                            ...
                            <div class='form-group row'>
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="time" value="{{ date("h:i:s") }}" id="example-text-input" name="time" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="number" id="example-text-input" name="period" required>
                                </div>
                            </div>
